...
var app = angular.module('mati', ['ngRoute', 'firebase']);

//The Firebase URL set as a Constant
app.constant('fbURL', 'https://mati.firebaseio.com');
...
app.controller('MainController', function ($scope, $firebase, Posts) {
    ...
    $scope.deletePost = function (post) {
        ...
        var postForDeletion = new Firebase('https://mati.firebaseio.com/' + post.$id);
    ...
    $scope.addComment = function (post, comment) {
        if ($scope.authData) {
            var ref = new Firebase('https://mati.firebaseio.com/' + post.$id + '/comments');
    ...
    $scope.removeComment = function(post, comment) {
        var commentForDeletion = new Firebase('https://mati.firebaseio.com/' + post.$id + '/comments/' + comment.$id);
    ...
    $scope.login = function () {
        ...
        var ref = new Firebase('https://mati.firebaseio.com/');
